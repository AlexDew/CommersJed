    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6">
        ...
        <p class="text-center">
          ...
          <a href="process/vaciarcarrito" class="btn btn-danger btn-block"><i class="fa fa-trash"></i> Vaciar
            carrito</a>
        </p>
      </div>
    </div>
...
<nav id="navbar-auto-hidden">
  <div class="row hidden-xs">
    ...
    <div class="col-xs-4">
      ...
      <p class="text-navbar tittles-pages-logo">MR JED</p>
    </div>
    <div class="col-xs-8">
      <div class="contenedor-tabla pull-right">
        <div class="contenedor-tr">
          <a href="inicio" class="table-cell-td">Inicio</a>
          <a href="productos" class="table-cell-td">Productos</a>
          <?php
          if (isset($_SESSION['session'])) {
            if ($_SESSION['nombreAdmin'] != "") {
              echo '<a href="configAdmin" class="table-cell-td">Administración</a>
              ...
              echo '<a href="pedido" class="table-cell-td">Pedido</a>
              <a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
              </a>
              <a href="#" class="table-cell-td" data-toggle="modal" data-target=".modal-logout">
            ...
            echo '<a href="registro" class="table-cell-td">Registro</a>
            <a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
            </a>
  ...
  <div class="row visible-xs">
    ...
    <div class="col-xs-12">
      ...
      <a href="#" id="button-shopping-cart-xs" class="elements-nav-xs all-elements-tooltip carrito-button-nav"
        data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
        <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-down"></i>
      </a>
      <?php
      if (isset($_SESSION['session'])) {
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content" id="modal-form-login">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en MR JED TRADE</h4>
      </div>
      <form action="process/login" method="post" role="form" style="margin: 20px;" class="FormCatElec"
        data-form="login">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" name="clave-login" placeholder="Escribe tu contraseña"
            required="" />
        </div>
...
<div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
  ...
  <ul class="list-unstyled text-center">
    ...
    if (isset($_SESSION['session'])) {
      ...
      echo '<li><a href="registration">Registro</a></li>';
    }
    ?>
  </ul>
</div>
...
<div class="modal fade modal-carrito" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <p class="text-center"><button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">Aceptar</button>
      </p>
    </div>
  </div>
</div>
...
<div class="modal fade modal-logout" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <p class="text-center">
        <a href="process/logout" class="btn btn-primary btn-sm">Cerrar la sesión</a>
        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Cancelar</button>
      </p>
    </div>
  </div>
